...
const projects = [
  { title: 'Movie Analysis Dashboard (PowerBI)', category: 'Data Science', description:' Imported the Excel file Bollywood Movies dataset into Power BI. Removed Unwanted Columns. Created new columns like Profit using DAX. Cleaned the data to handle missing values and outliers. Built a dashboard with Cards, Charts, Slicers, and Filters.', img:"/pbi1.jpg", links:"https://www.linkedin.com/feed/update/urn:li:activity:7211301040359403520/" },
