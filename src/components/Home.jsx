    ...
    return (
        <div className='home container my-5'>
            <div className='hp1 text-wrap'>
                ...
                <p style={{ fontSize: '58px' }}><b>Frontend Developer & Robotics Engineer</b></p>
                <p>I am a passionate engineer with skills in Robotics and Frontend development. I am pursuing my specialisation
                    in Data Science and Artificial Intelligence. With expertise in Emebdded C,
                    JavaScript,React.js, Java, Arduino programming, python, IBM Cloud and Git. Take a look at my projects
